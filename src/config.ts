...
export const SOCIALS: SocialObjects = [
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/theusnunis/",
    linkTitle: `${SITE.title} on Instagram`,
    active: true,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/matheus-nunes-ismael-82675914b/",
    linkTitle: `${SITE.title} on LinkedIn`,
    active: true,
  },
  {
    name: "Mail",
    href: "mailto:numnes@proton.me",
